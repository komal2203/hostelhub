...
import { Utensils, Search, BarChart3 } from "lucide-react";
...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <Link to="/home/mess">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-semibold mb-4 text-rose-700">Rate Your Mess</h3>
                                <p className="text-gray-600">Share your dining experience and help others make informed choices about their meals.</p>
                            </motion.div>
                        </Link>
                        ...
                        <Link to="/home/lost">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-semibold mb-4 text-rose-700">Lost & Found</h3>
                                <p className="text-gray-600">Lost something? Found something? Our platform helps you connect with your belongings.</p>
                            </motion.div>
                        </Link>
            ...
            <div className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-rose-800">How It Works</h2>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        {[{
                            number: 1,
                            title: "Sign Up",
                            ...
                            >
                                <div className="bg-rose-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <span className="text-2xl font-bold text-rose-600">{number}</span>
                                </div>
            ...
            <div className="py-20 bg-rose-100">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-rose-800">What Students Say</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[{
                            initial: "R",
                            name: "Rahul Sharma",
            ...
            {/* Call to Action Section */}
            <motion.div
                className="py-15 bg-gradient-to-r from-red-600 via-pink-600 to-pink-400 text-white"
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, ease: "easeOut" }}
            >
